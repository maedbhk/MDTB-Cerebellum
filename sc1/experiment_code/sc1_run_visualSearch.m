function [T, score] = sc1_run_visualSearch(screen,keyNames,T)
...
for trial = 1:numTrials,
    ...
    % Make search display
    img = makeSearchDisplay(imTarg,imDist,T.setSize(trial),targetPresent,T.rotateDistractor(trial),screen.grey,screen.height-50,screen.width-50); % rotateDistractor can also be included here
